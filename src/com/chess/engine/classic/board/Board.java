...
import com.chess.engine.classic.randomizing.Algorithm;
...
public final class Board {
    ...
    public static Board createStandardBoardImpl() {
        ...
        Algorithm boardRandomizer = new Algorithm(builder, 1000, 500, Alliance.BLACK);
        boardRandomizer.Randomize(Alliance.BLACK);
        // White Layout
        ...
        boardRandomizer = new Algorithm(builder, 1000, 500, Alliance.WHITE);
        boardRandomizer.Randomize(Alliance.WHITE);
        //white to move
